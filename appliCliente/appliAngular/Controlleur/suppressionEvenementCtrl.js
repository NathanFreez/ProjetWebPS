...
angular.module('myEventApp')
        .controller('suppressionEvenementCtrl', ["$scope", "EvenementFactory", function ($scope, EvtFacto) { //Injection du $scope mais également de notre service CompteFactory
                ...
                $scope.suppEvt = function () {
                    ...
                    //suppression d'evenement (envoie d'un POST à l'URL de la ressource)
                    $scope.evenement.$save(function () {
                        //suppression OK, on indique juste que le traitement est terminée
                ...
                $scope.evenement = new EvtFacto.SupprEvenement(); //suppression d'une instance de ressource Evenement
